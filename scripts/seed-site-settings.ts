  ...
  try {
    ...
    const settings = await prisma.siteSettings.create({
      data: {
        ...
        metaDescription: 'Leading Egyptian company exporting premium marble, granite and quartz worldwide. Premium natural stones from Egypt.',
        metaDescriptionAr: 'شركة مصرية رائدة في تصدير الرخام والجرانيت والكوارتز الفاخر عالمياً. أحجار طبيعية فاخرة من مصر.',
        keywords: 'marble, granite, quartz, export, Egypt, natural stone, premium stones, marble tiles, granite slabs',
        keywordsAr: 'رخام, جرانيت, كوارتز, تصدير, مصر, أحجار طبيعية, رخام فاخر, بلاط رخام, ألواح جرانيت',
        
        // Business Hours
        businessHours: 'Sunday - Thursday: 9:00 AM - 6:00 PM, Friday: Closed, Saturday: 10:00 AM - 4:00 PM',
        businessHoursAr: 'الأحد - الخميس: 9:00 ص - 6:00 م، الجمعة: مغلق، السبت: 10:00 ص - 4:00 م',
