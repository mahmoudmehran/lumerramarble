...
export default function Navbar({ locale }: NavbarProps) {
  ...
  const logoUrl = useMemo(() => {
    const mainLogo = siteSettings?.headerLogoUrl
  ...
  const logoAlt = useMemo(() => {
    ...
    // Use only headerLogoAlt (removed fallback to old logoAlt)
    const altAr = siteSettings.headerLogoAltAr || 'شعار الشركة'
    const altEs = siteSettings.headerLogoAltEs || 'Logo de la Empresa'
    const altFr = siteSettings.headerLogoAltFr || 'Logo de l\'Entreprise'
    const altEn = siteSettings.headerLogoAlt || 'Company Logo'
  ...
  return (
    <nav 
      className={`bg-[var(--color-quinary)] shadow-lg fixed top-0 left-0 right-0 z-[100] border-b border-[var(--color-quaternary-100)] transition-all duration-300 ${
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="md:hidden relative z-[10]">
            <button
              ...
              className="text-[var(--color-quaternary)] hover:text-[var(--color-primary)] focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[var(--color-primary)] p-2 rounded-md touch-action-manipulation cursor-pointer"
          ...
          <div className="hidden md:flex items-center justify-center flex-1 px-8 relative z-[1]">
          ...
          <div className="hidden md:flex items-center gap-4 flex-shrink-0 relative z-[1]">
            ...
            <div className="relative" ref={langDropdownRef}>
              <button
                ...
                className="flex items-center gap-2 text-[var(--color-quaternary)] hover:text-[var(--color-primary)] px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 border border-[var(--color-quaternary-200)] hover:border-[var(--color-primary)] hover:shadow-md bg-[var(--color-quinary)] h-10 min-w-[120px] justify-between touch-action-manipulation cursor-pointer relative z-[1]"
              >
              ...
              {langOpen && (
                <div className="absolute right-0 rtl:right-auto rtl:left-0 mt-2 min-w-[220px] bg-[var(--color-quinary)] rounded-lg shadow-2xl py-2 z-[110] border-2 border-[var(--color-primary-100)] ">
